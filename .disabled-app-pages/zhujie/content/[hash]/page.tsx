...
import { colors } from '@zhujie/styles/theme';
import type { ContentMapResponse } from '@zhujie/lib/types';
import type { LineDecomposition, YuKuai, UserYuKuai } from '@zhujie/lib/yukuai-types';
import LineList from '@zhujie/components/LineList';
import AnnotationView from '@zhujie/components/AnnotationView';
...
export default function ContentWorkspace() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/zhujie/content-map?hash=${hash}`)
      .then((res) => {
  ...
  const handleLineClick = useCallback(
    async (lineIndex: number) => {
      ...
      setLoading(true);
      try {
        const res = await fetch('/api/zhujie/decompose-line', {
          method: 'POST',
