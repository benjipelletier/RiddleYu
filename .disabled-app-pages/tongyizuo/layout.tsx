...
export default function TongyizuoLayout({ children }: { children: React.ReactNode }) {
  return (
    <>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        ::view-transition-old(root) { animation: 220ms ease-out both vtFadeOut; }
        ::view-transition-new(root) { animation: 280ms ease-in both vtFadeIn; }
        @keyframes vtFadeOut { from { opacity: 1; transform: scale(1); } to { opacity: 0; transform: scale(0.97); } }
        ...
        @keyframes uiFadeDown { from { opacity: 0; transform: translateY(-8px); } to { opacity: 1; transform: translateY(0); } }
