...
import { getLineAnnotation, ensureTables } from '@zhujie/lib/db';
import type { AnnotateLineRequest } from '@zhujie/lib/types';
...
export async function POST(request: NextRequest) {
  try {
    ...
    return NextResponse.json({ error: 'Use /api/zhujie/decompose-line for new annotations' }, { status: 410 });
  } catch (error) {
