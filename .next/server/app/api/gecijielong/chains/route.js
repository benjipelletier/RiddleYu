(()=>{var a={};a.id=621,a.ids=[621],a.modules={261:a=>{"use strict";a.exports=require("next/dist/shared/lib/router/utils/app-paths")},846:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},3033:a=>{"use strict";a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},4553:(a,b,c)=>{"use strict";c.d(b,{L:()=>f});var d=c(9608);let e=null;function f(){return e||(e=(0,d.lw)(process.env.GECIJIELONG_DATABASE_URL)),e}},4870:a=>{"use strict";a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},6439:a=>{"use strict";a.exports=require("next/dist/shared/lib/no-fallback-error.external")},6487:()=>{},8335:()=>{},9093:(a,b,c)=>{"use strict";c.r(b),c.d(b,{handler:()=>B,patchFetch:()=>A,routeModule:()=>w,serverHooks:()=>z,workAsyncStorage:()=>x,workUnitAsyncStorage:()=>y});var d={};c.r(d),c.d(d,{GET:()=>v});var e=c(5736),f=c(9117),g=c(4044),h=c(9326),i=c(2324),j=c(261),k=c(4290),l=c(5328),m=c(8928),n=c(6595),o=c(3421),p=c(7679),q=c(1681),r=c(3446),s=c(6439),t=c(1356),u=c(4553);async function v(a){let b=(0,u.L)(),c=a.nextUrl.searchParams.get("line_id"),d=a.nextUrl.searchParams.get("mode")||"pinyin";if(!c)return Response.json({error:"line_id is required"},{status:400});if(!["char","pinyin","toneless"].includes(d))return Response.json({error:"Invalid mode"},{status:400});let e=await b`
    SELECT * FROM (
